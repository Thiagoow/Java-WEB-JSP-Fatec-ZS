...
<%
    ...
    List<Games> inst = inscont.listar(cli);
        ...
        <table class="striped responsive-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="excluirGames.jsp?<%=url + listaGames.getId()%>">Excluir</a></td>
                    <td><a href="alterarGames.jsp?<%=url + listaGames.getId()%>">Alterar</a></td>
                    <% } %>
                </tr>
                <% } %>
            </tbody>
